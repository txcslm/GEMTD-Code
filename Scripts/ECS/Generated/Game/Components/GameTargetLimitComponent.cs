...
public partial class GameEntity {
    ...
    public Game.Battle.TargetLimitComponent targetLimit { get { return (Game.Battle.TargetLimitComponent)GetComponent(GameComponentsLookup.TargetLimit); } }
    ...
    public GameEntity AddTargetLimit(int newValue) {
        ...
        var component = (Game.Battle.TargetLimitComponent)CreateComponent(index, typeof(Game.Battle.TargetLimitComponent));
