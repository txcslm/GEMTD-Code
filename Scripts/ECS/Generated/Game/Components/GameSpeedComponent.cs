...
public partial class GameEntity {
    ...
    public Game.Towers.SpeedComponent speed { get { return (Game.Towers.SpeedComponent)GetComponent(GameComponentsLookup.Speed); } }
    ...
    public GameEntity AddSpeed(float newValue) {
        ...
        var component = (Game.Towers.SpeedComponent)CreateComponent(index, typeof(Game.Towers.SpeedComponent));
