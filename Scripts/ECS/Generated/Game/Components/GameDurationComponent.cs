...
public partial class GameEntity {
    ...
    public Game.Battle.DurationComponent duration { get { return (Game.Battle.DurationComponent)GetComponent(GameComponentsLookup.Duration); } }
    ...
    public GameEntity AddDuration(float newValue) {
        ...
        var component = (Game.Battle.DurationComponent)CreateComponent(index, typeof(Game.Battle.DurationComponent));
