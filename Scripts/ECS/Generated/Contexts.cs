...
public partial class Contexts {
    ...
    public void InitializeEntityIndices() {
        game.AddEntityIndex(new Entitas.EntityIndex<GameEntity, int>(
            ...
            (e, c) => ((Game.Battle.ApplierStatusLinkComponent)c).Value));

        game.AddEntityIndex(new Entitas.EntityIndex<GameEntity, int>(
            EntityLink,
            game.GetGroup(GameMatcher.EntityLink),
            (e, c) => ((Game.CommonComponents.EntityLinkComponent)c).Value));

        game.AddEntityIndex(new Entitas.PrimaryEntityIndex<GameEntity, int>(
            Id,
            game.GetGroup(GameMatcher.Id),
            (e, c) => ((Game.CommonComponents.IdComponent)c).Value));

        game.AddEntityIndex(new Entitas.EntityIndex<GameEntity, Game.Battle.AbilityEnum>(
            ParentAbility,
            game.GetGroup(GameMatcher.ParentAbility),
            (e, c) => ((Game.Battle.ParentAbilityComponent)c).Value));
    }
}
...
public static class ContextsExtensions {
    ...
    public static System.Collections.Generic.HashSet<GameEntity> GetEntitiesWithParentAbility(this GameContext context, Game.Battle.AbilityEnum Value) {
        return ((Entitas.EntityIndex<GameEntity, Game.Battle.AbilityEnum>)context.GetEntityIndex(Contexts.ParentAbility)).GetEntities(Value);
    }
}
//------------------------------------------------------------------------------
// <auto-generated>
